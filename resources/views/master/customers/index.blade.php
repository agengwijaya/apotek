...
@section('content')
                  ...
                  <div class="row row-cols-auto justify-content-between mb-3">
                    ...
                    <div class="col">
                      <div class="form-group">
                        <button type="button" class="btn btn-primary form-control" data-bs-toggle="modal" data-bs-target="#modalAddCustomer"><i class="fa fa-plus"></i> Tambah Pelanggan</button>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                        ...
                        <tbody>
                          @foreach ($customers as $item)
                            <tr>
                              ...
                              <td class="text-center">{{ $item->KdPelanggan }}</td>
                              <td>{{ $item->NmPelanggan }}</td>
                              <td>{{ $item->Alamat }}</td>
                              <td>{{ $item->Kota }}</td>
                              <td>{{ $item->Telpon }}</td>
      ...
      <div class="modal-content">
        <form action="{{ url('data-master/data-customers') }}" method="POST">
          ...
          <div class="modal-header">
            <h5 class="modal-title" id="modalAddCustomerLabel">Form Tambah Data Pelanggan</h5>
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="KdPelanggan" name="KdPelanggan" value="{{ $code }}" readonly>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-3">
                  <label for="nama" class="form-label">Nama</label>
                  <input type="text" class="form-control" id="NmPelanggan" name="NmPelanggan" autocomplete="off" required>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form method="POST" id="form_edit">
          ...
          @csrf
          <div class="modal-header">
            <h5 class="modal-title" id="modalEditLabel">Edit Data Pelanggan</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="row">
  ...
  <script>
    $('#transaksi').on('click', 'tbody td #btn_edit', function() {
      ...
      $('#KdPelanggan_edit').val(data.KdPelanggan);
      $('#NmPelanggan_edit').val(data.NmPelanggan);
